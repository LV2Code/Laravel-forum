                ...
                @if( !in_array( Request::segment(1), [ 'login', 'register' ] ) )
                    ...
                    <div class="col-md-4">
                        ...
                        <div style="padding-bottom: 10px">
                            ...
                            <a href="{{ route( 'discussions.create' ) }}" class="btn btn-primary btn-block">

                                <i class="fas fa-lg fa-microphone"></i> Start A Discussion
                        ...
                        <ul class="list-group"  style="margin-top: 15px">
                            ...
                            <li class="list-group-item">
                                ...
                                <a  href="{{ route( 'discussions.answered' ) }}"
                            ...
                            <li class="list-group-item">
                                ...
                                <a  href="{{ route( 'discussions.unanswered' ) }}"
